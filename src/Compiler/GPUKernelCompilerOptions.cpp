...
const std::string GPUKernelCompilerOptions::REGIR_SPATIAL_REUSE_DO_PAIRWISE_MIS = "ReGIR_SpatialReuseDoPairwiseMIS";
...
const std::unordered_set<std::string> GPUKernelCompilerOptions::ALL_MACROS_NAMES = {
	...
	GPUKernelCompilerOptions::REGIR_SPATIAL_REUSE_DO_PAIRWISE_MIS,
...
GPUKernelCompilerOptions::GPUKernelCompilerOptions()
{
	...
	m_options_macro_map[GPUKernelCompilerOptions::REGIR_SPATIAL_REUSE_DO_PAIRWISE_MIS] = std::make_shared<int>(ReGIR_SpatialReuseDoPairwiseMIS);
