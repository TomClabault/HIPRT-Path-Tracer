...
const std::string GPUKernelCompilerOptions::REGIR_HASH_GRID_LINEAR_PROBING_STEPS = "ReGIR_HashGridLinearProbingSteps";
...
const std::unordered_set<std::string> GPUKernelCompilerOptions::ALL_MACROS_NAMES = {
	...
	GPUKernelCompilerOptions::REGIR_HASH_GRID_LINEAR_PROBING_STEPS,
...
GPUKernelCompilerOptions::GPUKernelCompilerOptions()
{
	...
	m_options_macro_map[GPUKernelCompilerOptions::REGIR_HASH_GRID_LINEAR_PROBING_STEPS] = std::make_shared<int>(ReGIR_HashGridLinearProbingSteps);
