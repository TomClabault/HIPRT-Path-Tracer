...
const std::string GPUKernelCompilerOptions::REGIR_SHADING_RESAMPLING_PAIRWISE_DUAL_STATEGIES = "ReGIR_ShadingResamplingPairwiseMISDualStrategies";
...
const std::unordered_set<std::string> GPUKernelCompilerOptions::ALL_MACROS_NAMES = {
	...
	GPUKernelCompilerOptions::REGIR_SHADING_RESAMPLING_PAIRWISE_DUAL_STATEGIES,
...
GPUKernelCompilerOptions::GPUKernelCompilerOptions()
{
	...
	m_options_macro_map[GPUKernelCompilerOptions::REGIR_SHADING_RESAMPLING_PAIRWISE_DUAL_STATEGIES] = std::make_shared<int>(ReGIR_ShadingResamplingPairwiseMISDualStrategies);
