...
public:
	...
	static const std::string PRINCIPLED_BSDF_MULTIPLE_SCATTERING_CUI_MAX_MICROSURFACE_VARIABLE_BOUNCES;
	static const std::string PRINCIPLED_BSDF_MULTIPLE_SCATTERING_CUI_DO_RUSSIAN_ROULETTE;
	...
	static const std::string PRINCIPLED_BSDF_SAMPLE_DIFFUSE_LUMINANCE;
	...
	static const std::string REGIR_GRID_FILL_CELL_DISTRIBUTIONS_CANONICAL_SAMPLING_TECHNIQUE;
	static const std::string REGIR_GRID_FILL_CELL_DISTRIBUTIONS_USE_REPRESENTATIVE_NORMAL;
	static const std::string REGIR_GRID_FILL_CELL_DISTRIBUTION_INTEGRATE_MESH;
	static const std::string REGIR_GRID_FILL_CELL_DISTRIBUTION_INTEGRATE_MESH_SAMPLE_COUNT;
	static const std::string REGIR_GRID_FILL_CELL_DISTRIBUTION_UNBIASED_NEE_PLUS_PLUS;
	static const std::string REGIR_GRID_FILL_LIGHT_SAMPLING_BASE_STRATEGY_NON_CANONICAL;
	static const std::string REGIR_GRID_FILL_LIGHT_SAMPLING_BASE_STRATEGY_CANONICAL;
	...
	static const std::string REGIR_SHADING_RESAMPLING_INCLUDE_CANONICAL_CANDIDATES;
	static const std::string REGIR_SHADING_RESAMPLING_CANONICAL_CANDIDATES_LIGHT_TREE_ATS;
	...
	static const std::string REGIR_SHADING_RESAMPLING_SAMPLE_ONLY_LIGHT_DISTRIBUTIONS;
	...
	static const std::string REGIR_HASH_GRID_HASH_FUZZY_NORMALS;
	...
	static const std::string ILLUMINATION_AWARE_KD_TREE_NISML_USE_NORMAL_DIVERSITY_HEURISTIC;
