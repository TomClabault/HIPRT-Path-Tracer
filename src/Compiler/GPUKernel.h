...
public:
	...
	void launch_timed_asynchronous(int tile_size_x, int tile_size_y, int res_x, int res_y, void** launch_args, oroStream_t stream, HIPRTOrochiCtx* hiprt_orochi_ctx);
