...
std::vector<unsigned char> Utils::tonemap_hdr_image(const float* hdr_image, size_t byte_size, int sample_number, float gamma, float exposure)
{
    std::vector<unsigned char> tonemapped_data(byte_size);
