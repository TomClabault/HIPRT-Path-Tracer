...
const std::string GPUBakerConstants::GGX_ESS_FILE_NAME = "GGX_Ess_" + std::to_string(GPUBakerConstants::GGX_ESS_TEXTURE_SIZE_COS_THETA_O) + "x" + std::to_string(GPUBakerConstants::GGX_ESS_TEXTURE_SIZE_ROUGHNESS) + ".hdr";
