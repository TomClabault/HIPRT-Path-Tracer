...
public:
	...
	void add_render_pass(const std::string& render_pass_name, std::shared_ptr<RenderPass> render_pass);
...
private:
	...
	void launch_render_pass_with_dependencies(const std::string& render_pass_name, std::shared_ptr<RenderPass> render_pass);
	...
	std::unordered_map<std::string, bool> m_render_pass_launched_this_frame_yet;
	...
	std::unordered_map<std::string, bool> m_render_pass_effectively_launched_this_frame;
