...
public:
	...
	bool launch_cell_alias_tables_precomputation(HIPRTRenderData& render_data, bool force_recompute = false);
	bool launch_cell_alias_tables_precomputation_internal(HIPRTRenderData& render_data, bool primary_hit, bool force_recompute = false);
