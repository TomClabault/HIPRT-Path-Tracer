...
public:
	...
	void launch_cell_alias_tables_precomputation(HIPRTRenderData& render_data, GPUKernelCompilerOptions& compiler_options, bool force_recompute = false);
	void launch_cell_alias_tables_precomputation_internal(HIPRTRenderData& render_data, bool primary_hit, bool force_recompute = false);
