...
#ifndef RENDERER_CPU_GPU_COMMON_DATA_STRUCTURES_RESTIR_PG_SUFFICIENT_STATISTICS_SOA_HOST_H
#define RENDERER_CPU_GPU_COMMON_DATA_STRUCTURES_RESTIR_PG_SUFFICIENT_STATISTICS_SOA_HOST_H
...
struct ReSTIRPGSufficientStatisticsSoAHost
{
	...
	ReSTIRPGDistributionSufficientStatisticsSoADevice to_device()
	{
		...
		soa_device.DEBUGSIZE = m_sufficient_statistics_data.template get_buffer<ReSTIRPGSufficientStatisticsSoAHostBuffers::RESTIR_PG_DIRECTIONS_SUMS_X>().size();
