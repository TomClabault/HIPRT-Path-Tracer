...
{
	void resize(unsigned int path_capacity, std::size_t ray_volume_state_byte_size)
	{
		m_wavefront_data.resize(path_capacity, { WAVEFRONT_PATH_VOLUME_STATE_BYTES, WAVEFRONT_QUEUE_COUNT_0, WAVEFRONT_QUEUE_COUNT_1 });
