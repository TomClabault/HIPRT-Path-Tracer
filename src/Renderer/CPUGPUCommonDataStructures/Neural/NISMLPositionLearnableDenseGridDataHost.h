...
#ifndef RENDERER_CPU_GPU_COMMON_DATA_STRUCTURES_NIS_ML_POSITION_LEARNABLE_DENSE_GRID_DATA_HOST_H
#define RENDERER_CPU_GPU_COMMON_DATA_STRUCTURES_NIS_ML_POSITION_LEARNABLE_DENSE_GRID_DATA_HOST_H
