...
void SceneParser::read_material_properties(aiMaterial* mesh_material, RendererMaterial& renderer_material)
{
    ...
    if (renderer_material.emission_texture_index == RendererMaterial::NO_TEXTURE)
    {
        ...
        renderer_material.set_emission(emission);
    }
    ...
    renderer_material.coat = 0.75f;
    renderer_material.coat_ior = 0.01f;
    renderer_material.ior = 0.01f;
    renderer_material.specular = 1.0f;
    renderer_material.roughness = 0.0f;
    /*renderer_material.sheen = 1.0f;
    renderer_material.specular = 0.0f;*/
    //renderer_material.metallic = 0.5f;
