...
#ifdef __KERNELCC__
GLOBAL_KERNEL_SIGNATURE(void) __launch_bounds__(64) ReSTIR_GI_DecoupledShading(HIPRTRenderData render_data)
#else
GLOBAL_KERNEL_SIGNATURE(void) inline ReSTIR_GI_DecoupledShading(HIPRTRenderData render_data, int x, int y)
#endif
{
#ifdef __KERNELCC__
	...
	ReSTIRGIReservoir* input_reservoir_buffer = render_data.render_settings.restir_gi_settings.restir_output_reservoirs;
