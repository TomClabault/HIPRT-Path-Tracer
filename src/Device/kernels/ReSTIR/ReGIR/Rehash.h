...
ReGIR_Rehash(HIPRTCamera current_camera,
...
#endif // #ifdef __KERNELCC__
{
	...
	ReGIRSettings::insert_hash_cell_data_static(new_hash_grid, new_hash_grid_soa, new_hash_cell_data, world_position, shading_normal, current_camera,
