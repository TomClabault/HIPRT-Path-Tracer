...
HIPRT_DEVICE unsigned int block_scan_early_publish(
    unsigned int thread_input_value, unsigned int bid, int tid, ParallelPrefixScanDecoupledLookbackBlockDescriptor* __restrict__ block_descs)
{
    // Per-warp scan
...
ParallelPrefixScanDecoupledLookback_Scan(
