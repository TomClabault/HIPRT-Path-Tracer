																		 ...
																		 float NoV)
{
	...
	if (energy_compensation_disabled || roughness_low_enough || no_specular_layer || invalid_view_direction)
		return 1.0f;
																			...
																			float NoV)
{
	...
	bool invalid_view_direction = NoV < 0.0f;
	if (energy_compensation_disabled || no_coat_layer || invalid_view_direction)
		return 1.0f;
