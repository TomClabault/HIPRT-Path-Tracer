...
HIPRT_DEVICE static ColorRGB32F torrance_sparrow_GGX_eval_reflect(const HIPRTRenderData& render_data, float material_roughness, float material_anisotropy, bool material_do_energy_compensation, const ColorRGB32F& F, 
 ...
 * Equation 15
 */
HIPRT_DEVICE static float torrance_sparrow_GGX_pdf_reflect(const HIPRTRenderData& render_data, float material_roughness, float material_anisotropy,
    const float3& local_view_direction, const float3& local_to_light_direction, const float3& local_halfway_vector,
...
HIPRT_DEVICE static ColorRGB32F torrance_sparrow_GGX_eval_refract(const DeviceUnpackedEffectiveMaterial& material, float roughness, float relative_eta, ColorRGB32F fresnel_reflectance,
    const float3& local_view_direction, const float3& local_to_light_direction, const float3& local_halfway_vector,
...
HIPRT_DEVICE static float torrance_sparrow_GGX_pdf_refract(const DeviceUnpackedEffectiveMaterial& material, float roughness, float relative_eta,
    const float3& local_view_direction, const float3& local_to_light_direction, const float3& local_halfway_vector,
 ...
 */
HIPRT_DEVICE static float3 GGX_VNDF_spherical_caps_sample(const float3 local_view_direction, float alpha_x, float alpha_y, Xorshift32Generator& random_number_generator)
{
    float r1 = random_number_generator();
    float r2 = random_number_generator();
 ...
 */
HIPRT_DEVICE static float3 GGX_anisotropic_sample_microfacet(const float3& local_view_direction, float alpha_x, float alpha_y, Xorshift32Generator& random_number_generator)
{
 ...
 */
HIPRT_DEVICE static float3 microfacet_GGX_sample_reflection(float roughness, float anisotropy, const float3& local_view_direction, Xorshift32Generator& random_number_generator)
{
