 ...
 */
HIPRT_DEVICE float GGX_anisotropic(float alpha_x, float alpha_y, const float3& local_microfacet_normal)
{
 ...
 * Equation 3
 */
HIPRT_DEVICE float GGX_anisotropic_vndf(float D, float G1V, const float3& local_view_direction, const float3& local_microfacet_normal)
{
 ...
 */
HIPRT_DEVICE float G1_Smith_lambda(float alpha_x, float alpha_y, const float3& local_direction)
{
 ...
 * Equation 43
 */
HIPRT_DEVICE float G1_Smith(float alpha_x, float alpha_y, const float3& local_direction)
{
...
HIPRT_DEVICE ColorRGB32F torrance_sparrow_GGX_eval_refract(const DeviceUnpackedEffectiveMaterial& material, float roughness, float relative_eta, ColorRGB32F fresnel_reflectance,
    const float3& local_view_direction, const float3& local_to_light_direction, const float3& local_halfway_vector,
...
HIPRT_DEVICE float torrance_sparrow_GGX_pdf_refract(const DeviceUnpackedEffectiveMaterial& material, float roughness, float relative_eta,
    const float3& local_view_direction, const float3& local_to_light_direction, const float3& local_halfway_vector,
 ...
 */
HIPRT_DEVICE float3 GGX_VNDF_sample(const float3 local_view_direction, float alpha_x, float alpha_y, Xorshift32Generator& random_number_generator)
{
 ...
 */
HIPRT_DEVICE float3 GGX_VNDF_spherical_caps_sample(const float3 local_view_direction, float alpha_x, float alpha_y, Xorshift32Generator& random_number_generator)
{
    float r1 = random_number_generator();
    float r2 = random_number_generator();
 ...
 */
HIPRT_DEVICE float3 GGX_anisotropic_sample_microfacet(const float3& local_view_direction, float alpha_x, float alpha_y, Xorshift32Generator& random_number_generator)
{
 ...
 */
HIPRT_DEVICE float3 microfacet_GGX_sample_reflection(float roughness, float anisotropy, const float3& local_view_direction, Xorshift32Generator& random_number_generator)
{
