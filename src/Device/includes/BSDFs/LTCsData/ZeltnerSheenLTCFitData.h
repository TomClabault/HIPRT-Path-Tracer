 ...
 * Reference:
 *
 * [1]: [Practical Multiple-Scattering Sheen Using Linearly Transformed Cosines - Github]
 * [https://github.com/tizian/ltc-sheen/blob/master/fitting/python/data/ltc_table_sheen_approx.cpp]
 */
