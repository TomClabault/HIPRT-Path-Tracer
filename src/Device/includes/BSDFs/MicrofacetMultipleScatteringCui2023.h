...
HIPRT_DEVICE inline ColorRGB32F computeD_F(
						const DeviceUnpackedEffectiveMaterial& material, float incident_ior, float alpha_x, float alpha_y, const float3& wi, const float3& wo)
{
