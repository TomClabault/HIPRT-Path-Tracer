...
HIPRT_HOST_DEVICE float F0_from_eta(float eta_t, float eta_i)
{
 ...
 */
HIPRT_HOST_DEVICE float F0_from_eta_t_and_relative_ior(float eta_t, float relative_eta)
{
 ...
 */
HIPRT_HOST_DEVICE ColorRGB32F fresnel_schlick(ColorRGB32F F0, float angle)
{
 ...
 */
HIPRT_HOST_DEVICE float full_fresnel_dielectric(float cos_theta_i, float relative_eta)
{
 ...
 */
HIPRT_HOST_DEVICE float full_fresnel_dielectric(float cos_theta_i, float eta_i, float eta_t)
{
 ...
 */
HIPRT_HOST_DEVICE ColorRGB32F fresnel_schlick_from_ior(float eta_i, float eta_t, float cos_theta_i)
{
 ...
 */
HIPRT_HOST_DEVICE ColorRGB32F fresnel_schlick_from_ior(float eta_i, float eta_t, const float3& normal, const float3& local_to_light_direction)
{
 ...
 */
HIPRT_HOST_DEVICE ColorRGB32F gulbrandsen_metallic_complex_fresnel(const ColorRGB32F& reflectivity, const ColorRGB32F& edge_tint, float cos_theta_i)
{
 ...
 */
HIPRT_HOST_DEVICE ColorRGB32F adobe_f82_tint_fresnel(const ColorRGB32F& F0, const ColorRGB32F& F82, const ColorRGB32F& F90, float F90_falloff_exponent, float cos_theta)
{
 ...
 */
HIPRT_HOST_DEVICE float fresnel_hemispherical_albedo_fit(float relative_eta)
{
