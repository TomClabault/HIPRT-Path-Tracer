...
HIPRT_DEVICE float get_jacobian_determinant_reconnection_shift(const float3_t& reconnection_point, const float3_t& reconnection_point_surface_normal, const float3_t& point_being_reconnected, const float3_t& vertex_before_reconnection_original_path, float jacobian_threshold)
{
