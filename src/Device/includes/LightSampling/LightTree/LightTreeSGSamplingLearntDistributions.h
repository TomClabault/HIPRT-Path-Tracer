																								 ...
																								 IlluminationAwareKDTreeSampledCutNode& out_sampled_cut_node)
{
	...
	unsigned int guiding_node_index = render_data.kd_tree_device.core.find_guiding_cell(shading_point);
	...
	const IlluminationAwareKDTreeNode& guiding_node = render_data.kd_tree_device.core.nodes[guiding_node_index];
	unsigned int guiding_distribution_index			= guiding_node.guiding_distribution_index;

	IlluminationAwareKDTreeSampledCutNode sampled_cut_node = render_data.kd_tree_device.nee_distributions.sample_global_cut_node(
