								  ...
								  float& out_specular_proba)
{
	...
	{
		float coat_reflected_radiance_triangle_ltc = evaluate_ltc(render_data, vertex_A_worldspace, vertex_B_worldspace, vertex_C_worldspace, shading_point,
																  view_direction, shading_normal, material, LTCLobe::COAT_LOBE) *
	...
	{
		float specular_radiance_triangle_ltc = evaluate_ltc(render_data, vertex_A_worldspace, vertex_B_worldspace, vertex_C_worldspace, shading_point,
															view_direction, shading_normal, material, LTCLobe::SPECULAR_LOBE) *
											   triangle_emission.luminance();

		specular_weight = (1.0f - material.metallic) * material.specular * specular_radiance_triangle_ltc;
	}

	float diffuse_radiance_triangle_ltc = evaluate_ltc(render_data, vertex_A_worldspace, vertex_B_worldspace, vertex_C_worldspace, shading_point,
														...
														const DeviceUnpackedEffectiveMaterial& material)
{
	...
	ltc_lobe_probas(render_data, vertex_A_worldspace, vertex_B_worldspace, vertex_C_worldspace, shading_point, view_direction, shading_normal,
					triangle_emission, material, lobe_probabilities.coat_proba, lobe_probabilities.metallic_proba, lobe_probabilities.specular_proba);
