 ...
 */
HIPRT_DEVICE float radical_inverse_base_2(unsigned int index) {
 ...
 */
HIPRT_DEVICE float2 sample_hammersley_2D(unsigned int number_of_points, unsigned int point_index)
{
 ...
 */
HIPRT_DEVICE float2 sample_in_disk(float radius, Xorshift32Generator& random_number_generator)
{
 ...
 * the MIS weight
 */
HIPRT_DEVICE float power_heuristic(float pdf_a, int nb_pdf_a, float pdf_b, int nb_pdf_b)
{
...
HIPRT_DEVICE float power_heuristic(float pdf_a, float pdf_b)
{
...
HIPRT_DEVICE float balance_heuristic(float pdf_a, float pdf_b)
{
    return balance_heuristic(pdf_a, 1, pdf_b, 1);
}

HIPRT_DEVICE float balance_heuristic(float pdf_a, float pdf_b, float pdf_c)
{
 ...
 */
HIPRT_DEVICE float3 reflect_ray(const float3& ray_direction, const float3& surface_normal)
{
 ...
 */
HIPRT_DEVICE float3 refract_ray(const float3& ray_direction, const float3& surface_normal, float relative_eta)
{
 ...
 */
HIPRT_DEVICE float3 cosine_weighted_sample_around_normal_world_space(const float3& normal, Xorshift32Generator& random_number_generator)
{
 ...
 */
HIPRT_DEVICE float3 cosine_weighted_sample_z_up_frame(Xorshift32Generator& random_number_generator)
{
