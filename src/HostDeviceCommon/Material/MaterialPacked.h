...
struct DevicePackedEffectiveMaterial
{
	...
	{
		return !hippt::is_zero(emission.r) || !hippt::is_zero(emission.g) || !hippt::is_zero(emission.b) || get_emissive_texture_used();
	}
	...
	HIPRT_HOST_DEVICE static DevicePackedEffectiveMaterial pack(const DeviceUnpackedEffectiveMaterial& unpacked)
	{
		...
		packed.set_retro_reflection(unpacked.retro_reflection);
	...
	HIPRT_HOST_DEVICE DeviceUnpackedEffectiveMaterial unpack() const
	{
		...
		unpacked.retro_reflection				 = this->get_retro_reflection();
	...
	{
		return flags.get_bool<PackedFlagsIndices::PACKED_EMISSIVE_TEXTURE_USED>();
	}

	HIPRT_HOST_DEVICE ColorRGB32F get_base_color() const
	{
		return base_color_roughness.get_color();
	}

	HIPRT_HOST_DEVICE float get_roughness() const
	{
		return base_color_roughness.get_float();
	}

	HIPRT_HOST_DEVICE float get_oren_nayar_sigma() const
	{
		return this->oren_nayar_sigma;
	}

	HIPRT_HOST_DEVICE float get_metallic() const
	{
		return metallic_F90_and_metallic.get_float();
	}

	HIPRT_HOST_DEVICE float get_metallic_F90_falloff_exponent() const
	{
		return this->metallic_F90_falloff_exponent;
	}

	HIPRT_HOST_DEVICE ColorRGB32F get_metallic_F82() const
	{
		return metallic_F82_packed_and_diffuse_transmission.get_color();
	}

	HIPRT_HOST_DEVICE ColorRGB32F get_metallic_F90() const
	{
		return metallic_F90_and_metallic.get_color();
	}

	HIPRT_HOST_DEVICE float get_anisotropy() const
	{
		return anisotropy_and_rotation_and_second_roughness.get_float<PackedAnisotropyGroupIndices::PACKED_ANISOTROPY>();
	}

	HIPRT_HOST_DEVICE float get_anisotropy_rotation() const
	{
		return anisotropy_and_rotation_and_second_roughness.get_float<PackedAnisotropyGroupIndices::PACKED_ANISOTROPY_ROTATION>();
	}

	HIPRT_HOST_DEVICE float get_second_roughness_weight() const
	{
		return anisotropy_and_rotation_and_second_roughness.get_float<PackedAnisotropyGroupIndices::PACKED_SECOND_ROUGHNESS_WEIGHT>();
	}

	HIPRT_HOST_DEVICE float get_second_roughness() const
	{
		return anisotropy_and_rotation_and_second_roughness.get_float<PackedAnisotropyGroupIndices::PACKED_SECOND_ROUGHNESS>();
	}

	HIPRT_HOST_DEVICE float get_retro_reflection() const
	{
		return specular_and_darkening_and_coat_roughness_and_retro_reflection.get_float<PackedSpecularGroupIndices::PACKED_RETRO_REFLECTION>();
	}

	HIPRT_HOST_DEVICE bool get_do_metallic_energy_compensation() const
	{
		return flags.get_bool<PackedFlagsIndices::METALLIC_ENERGY_COMPENSATION>();
	}

	HIPRT_HOST_DEVICE float get_specular() const
	{
		return specular_and_darkening_and_coat_roughness_and_retro_reflection.get_float<PackedSpecularGroupIndices::PACKED_SPECULAR>();
	}

	HIPRT_HOST_DEVICE float get_specular_tint() const
	{
		return specular_color_and_tint_factor.get_float();
	}

	HIPRT_HOST_DEVICE ColorRGB32F get_specular_color() const
	{
		return specular_color_and_tint_factor.get_color();
	}

	HIPRT_HOST_DEVICE float get_specular_darkening() const
	{
		return specular_and_darkening_and_coat_roughness_and_retro_reflection.get_float<PackedSpecularGroupIndices::PACKED_SPECULAR_DARKENING>();
	}

	HIPRT_HOST_DEVICE bool get_do_specular_energy_compensation() const
	{
		return flags.get_bool<PackedFlagsIndices::SPECULAR_ENERGY_COMPENSATION>();
	}

	HIPRT_HOST_DEVICE float get_coat() const
	{
		return coat_and_medium_absorption.get_float();
	}

	HIPRT_HOST_DEVICE ColorRGB32F get_coat_medium_absorption() const
	{
		return coat_and_medium_absorption.get_color();
	}

	HIPRT_HOST_DEVICE float get_coat_medium_thickness() const
	{
		return this->coat_medium_thickness;
	}

	HIPRT_HOST_DEVICE float get_coat_roughness() const
	{
		return specular_and_darkening_and_coat_roughness_and_retro_reflection.get_float<PackedSpecularGroupIndices::PACKED_COAT_ROUGHNESS>();
	}

	HIPRT_HOST_DEVICE float get_coat_roughening() const
	{
		return coat_roughening_darkening_anisotropy_and_rotation.get_float<PackedCoatGroupIndices::PACKED_COAT_ROUGHENING>();
	}

	HIPRT_HOST_DEVICE float get_coat_darkening() const
	{
		return coat_roughening_darkening_anisotropy_and_rotation.get_float<PackedCoatGroupIndices::PACKED_COAT_DARKENING>();
	}

	HIPRT_HOST_DEVICE float get_coat_anisotropy() const
	{
		return coat_roughening_darkening_anisotropy_and_rotation.get_float<PackedCoatGroupIndices::PACKED_COAT_ANISOTROPY>();
	}

	HIPRT_HOST_DEVICE float get_coat_anisotropy_rotation() const
	{
		return coat_roughening_darkening_anisotropy_and_rotation.get_float<PackedCoatGroupIndices::PACKED_COAT_ANISOTROPY_ROTATION>();
	}

	HIPRT_HOST_DEVICE float get_coat_ior() const
	{
		return this->coat_ior;
	}

	HIPRT_HOST_DEVICE bool get_do_coat_energy_compensation() const
	{
		return flags.get_bool<PackedFlagsIndices::CLEARCOAT_ENERGY_COMPENSATION>();
	}

	HIPRT_HOST_DEVICE float get_sheen() const
	{
		return sheen_and_color.get_float();
	}

	HIPRT_HOST_DEVICE float get_sheen_roughness() const
	{
		return sheen_roughness_transmission_dispersion_thin_film.get_float<PackedSheenRoughnessGroupIndices::PACKED_SHEEN_ROUGHNESS>();
	}

	HIPRT_HOST_DEVICE ColorRGB32F get_sheen_color() const
	{
		return sheen_and_color.get_color();
	}

	HIPRT_HOST_DEVICE float get_ior() const
	{
		return this->ior;
	}

	HIPRT_HOST_DEVICE float get_specular_transmission() const
	{
		return sheen_roughness_transmission_dispersion_thin_film.get_float<PackedSheenRoughnessGroupIndices::PACKED_SPECULAR_TRANSMISSION>();
	}

	HIPRT_HOST_DEVICE float get_diffuse_transmission() const
	{
		return metallic_F82_packed_and_diffuse_transmission.get_float();
	}

	HIPRT_HOST_DEVICE float get_absorption_at_distance() const
	{
		return this->absorption_at_distance;
	}

	HIPRT_HOST_DEVICE ColorRGB32F get_absorption_color() const
	{
		return absorption_color_packed.get_color();
	}

	HIPRT_HOST_DEVICE float get_dispersion_scale() const
	{
		return sheen_roughness_transmission_dispersion_thin_film.get_float<PackedSheenRoughnessGroupIndices::PACKED_DISPERSION_SCALE>();
	}

	HIPRT_HOST_DEVICE float get_dispersion_abbe_number() const
	{
		return this->dispersion_abbe_number;
	}

	HIPRT_HOST_DEVICE bool get_thin_walled() const
	{
		return flags.get_bool<PackedFlagsIndices::PACKED_THIN_WALLED>();
	}

	HIPRT_HOST_DEVICE bool get_do_glass_energy_compensation() const
	{
		return flags.get_bool<PackedFlagsIndices::GLASS_ENERGY_COMPENSATION>();
	}

	HIPRT_HOST_DEVICE float get_thin_film() const
	{
		return sheen_roughness_transmission_dispersion_thin_film.get_float<PackedSheenRoughnessGroupIndices::PACKED_THIN_FILM>();
	}

	HIPRT_HOST_DEVICE float get_thin_film_ior() const
	{
		return this->thin_film_ior;
	}

	HIPRT_HOST_DEVICE float get_thin_film_thickness() const
	{
		return this->thin_film_thickness;
	}

	HIPRT_HOST_DEVICE float get_thin_film_kappa_3() const
	{
		return this->thin_film_kappa_3;
	}

	HIPRT_HOST_DEVICE float get_thin_film_hue_shift_degrees() const
	{
		return alpha_thin_film_hue_dielectric_priority.get_float<PackedAlphaOpacityGroupIndices::PACKED_THIN_FILM_HUE_SHIFT>();
	}

	HIPRT_HOST_DEVICE float get_thin_film_base_ior_override() const
	{
		return this->thin_film_base_ior_override;
	}

	HIPRT_HOST_DEVICE bool get_thin_film_do_ior_override() const
	{
		return flags.get_bool<PackedFlagsIndices::PACKED_THIN_FILM_DO_IOR_OVERRIDE>();
	}

	HIPRT_HOST_DEVICE float get_alpha_opacity() const
	{
		return alpha_thin_film_hue_dielectric_priority.get_float<PackedAlphaOpacityGroupIndices::PACKED_ALPHA_OPACITY>();
	}

	HIPRT_HOST_DEVICE unsigned char get_dielectric_priority() const
	{
		return alpha_thin_film_hue_dielectric_priority.get_uchar<PackedAlphaOpacityGroupIndices::PACKED_DIELECTRIC_PRIORITY>();
	}

	HIPRT_HOST_DEVICE unsigned char get_energy_preservation_monte_carlo_samples() const
	{
		return alpha_thin_film_hue_dielectric_priority.get_uchar<PackedAlphaOpacityGroupIndices::PACKED_ENERGY_PRESERVATION_SAMPLES>();
	}

	HIPRT_HOST_DEVICE bool get_enforce_strong_energy_conservation() const
	{
		return flags.get_bool<PackedFlagsIndices::PACKED_ENFORCE_STRONG_ENERGY_CONSERVATION>();
	}

	HIPRT_HOST_DEVICE void set_emission(ColorRGB32F emission_)
	{
	...
	HIPRT_HOST_DEVICE void set_base_color(ColorRGB32F base_color)
	{
		base_color_roughness.set_color(base_color);
	}

	HIPRT_HOST_DEVICE void set_roughness(float roughness)
	{
		base_color_roughness.set_float(roughness);
	}

	HIPRT_HOST_DEVICE void set_oren_nayar_sigma(float oren_nayar_sigma_)
	{
		this->oren_nayar_sigma = oren_nayar_sigma_;
	}

	HIPRT_HOST_DEVICE void set_metallic(float metallic)
	{
		metallic_F90_and_metallic.set_float(metallic);
	}

	HIPRT_HOST_DEVICE void set_metallic_F90_falloff_exponent(float metallic_F90_falloff_exponent_)
	{
		this->metallic_F90_falloff_exponent = metallic_F90_falloff_exponent_;
	}

	HIPRT_HOST_DEVICE void set_metallic_F82(ColorRGB32F metallic_F82)
	{
		metallic_F82_packed_and_diffuse_transmission.set_color(metallic_F82);
	}

	HIPRT_HOST_DEVICE void set_metallic_F90(ColorRGB32F metallic_F90)
	{
		metallic_F90_and_metallic.set_color(metallic_F90);
	}

	HIPRT_HOST_DEVICE void set_anisotropy(float anisotropy)
	{
		anisotropy_and_rotation_and_second_roughness.set_float<PackedAnisotropyGroupIndices::PACKED_ANISOTROPY>(anisotropy);
	}

	HIPRT_HOST_DEVICE void set_anisotropy_rotation(float anisotropy_rotation)
	{
		anisotropy_and_rotation_and_second_roughness.set_float<PackedAnisotropyGroupIndices::PACKED_ANISOTROPY_ROTATION>(anisotropy_rotation);
	}

	HIPRT_HOST_DEVICE void set_second_roughness_weight(float second_roughness_weight)
	{
		anisotropy_and_rotation_and_second_roughness.set_float<PackedAnisotropyGroupIndices::PACKED_SECOND_ROUGHNESS_WEIGHT>(second_roughness_weight);
	}

	HIPRT_HOST_DEVICE void set_second_roughness(float second_roughness)
	{
		anisotropy_and_rotation_and_second_roughness.set_float<PackedAnisotropyGroupIndices::PACKED_SECOND_ROUGHNESS>(second_roughness);
	}

	HIPRT_HOST_DEVICE void set_retro_reflection(float retro_reflection)
	{
		specular_and_darkening_and_coat_roughness_and_retro_reflection.set_float<PackedSpecularGroupIndices::PACKED_RETRO_REFLECTION>(retro_reflection);
	}

	HIPRT_HOST_DEVICE void set_metallic_energy_compensation(bool do_metallic_energy_compensation)
	{
		flags.set_bool<PackedFlagsIndices::METALLIC_ENERGY_COMPENSATION>(do_metallic_energy_compensation);
	}

	HIPRT_HOST_DEVICE void set_specular(float specular)
	{
		specular_and_darkening_and_coat_roughness_and_retro_reflection.set_float<PackedSpecularGroupIndices::PACKED_SPECULAR>(specular);
	}

	HIPRT_HOST_DEVICE void set_specular_tint(float specular_tint)
	{
		specular_color_and_tint_factor.set_float(specular_tint);
	}

	HIPRT_HOST_DEVICE void set_specular_color(ColorRGB32F specular_color)
	{
		specular_color_and_tint_factor.set_color(specular_color);
	}

	HIPRT_HOST_DEVICE void set_specular_darkening(float specular_darkening)
	{
		specular_and_darkening_and_coat_roughness_and_retro_reflection.set_float<PackedSpecularGroupIndices::PACKED_SPECULAR_DARKENING>(specular_darkening);
	}

	HIPRT_HOST_DEVICE void set_specular_energy_compensation(bool do_specular_energy_compensation)
	{
		flags.set_bool<PackedFlagsIndices::SPECULAR_ENERGY_COMPENSATION>(do_specular_energy_compensation);
	}

	HIPRT_HOST_DEVICE void set_coat(float coat)
	{
		coat_and_medium_absorption.set_float(coat);
	}

	HIPRT_HOST_DEVICE void set_coat_medium_absorption(ColorRGB32F coat_medium_absorption)
	{
		coat_and_medium_absorption.set_color(coat_medium_absorption);
	}

	HIPRT_HOST_DEVICE void set_coat_medium_thickness(float coat_medium_thickness_)
	{
		this->coat_medium_thickness = coat_medium_thickness_;
	}

	HIPRT_HOST_DEVICE void set_coat_roughness(float coat_roughness)
	{
		specular_and_darkening_and_coat_roughness_and_retro_reflection.set_float<PackedSpecularGroupIndices::PACKED_COAT_ROUGHNESS>(coat_roughness);
	}

	HIPRT_HOST_DEVICE void set_coat_roughening(float coat_roughening)
	{
		coat_roughening_darkening_anisotropy_and_rotation.set_float<PackedCoatGroupIndices::PACKED_COAT_ROUGHENING>(coat_roughening);
	}

	HIPRT_HOST_DEVICE void set_coat_darkening(float coat_darkening)
	{
		coat_roughening_darkening_anisotropy_and_rotation.set_float<PackedCoatGroupIndices::PACKED_COAT_DARKENING>(coat_darkening);
	}

	HIPRT_HOST_DEVICE void set_coat_anisotropy(float coat_anisotropy)
	{
		coat_roughening_darkening_anisotropy_and_rotation.set_float<PackedCoatGroupIndices::PACKED_COAT_ANISOTROPY>(coat_anisotropy);
	}

	HIPRT_HOST_DEVICE void set_coat_anisotropy_rotation(float coat_anisotropy_rotation)
	{
		coat_roughening_darkening_anisotropy_and_rotation.set_float<PackedCoatGroupIndices::PACKED_COAT_ANISOTROPY_ROTATION>(coat_anisotropy_rotation);
	}

	HIPRT_HOST_DEVICE void set_coat_ior(float coat_ior_)
	{
		this->coat_ior = coat_ior_;
	}

	HIPRT_HOST_DEVICE void set_coat_energy_compensation(bool do_coat_energy_compensation)
	{
		flags.set_bool<PackedFlagsIndices::CLEARCOAT_ENERGY_COMPENSATION>(do_coat_energy_compensation);
	}

	HIPRT_HOST_DEVICE void set_sheen(float sheen)
	{
		sheen_and_color.set_float(sheen);
	}

	HIPRT_HOST_DEVICE void set_sheen_roughness(float sheen_roughness)
	{
		sheen_roughness_transmission_dispersion_thin_film.set_float<PackedSheenRoughnessGroupIndices::PACKED_SHEEN_ROUGHNESS>(sheen_roughness);
	}

	HIPRT_HOST_DEVICE void set_sheen_color(ColorRGB32F sheen_color)
	{
		sheen_and_color.set_color(sheen_color);
	}

	HIPRT_HOST_DEVICE void set_ior(float ior_)
	{
		this->ior = ior_;
	}

	HIPRT_HOST_DEVICE void set_specular_transmission(float specular_transmission)
	{
		sheen_roughness_transmission_dispersion_thin_film.set_float<PackedSheenRoughnessGroupIndices::PACKED_SPECULAR_TRANSMISSION>(specular_transmission);
	}

	HIPRT_HOST_DEVICE void set_diffuse_transmission(float diffuse_transmission)
	{
		metallic_F82_packed_and_diffuse_transmission.set_float(diffuse_transmission);
	}

	HIPRT_HOST_DEVICE void set_absorption_at_distance(float absorption_at_distance_)
	{
		this->absorption_at_distance = absorption_at_distance_;
	}

	HIPRT_HOST_DEVICE void set_absorption_color(ColorRGB32F absorption_color)
	{
		absorption_color_packed.set_color(absorption_color);
	}

	HIPRT_HOST_DEVICE void set_dispersion_scale(float dispersion_scale)
	{
		sheen_roughness_transmission_dispersion_thin_film.set_float<PackedSheenRoughnessGroupIndices::PACKED_DISPERSION_SCALE>(dispersion_scale);
	}

	HIPRT_HOST_DEVICE void set_dispersion_abbe_number(float dispersion_abbe_number_)
	{
		this->dispersion_abbe_number = dispersion_abbe_number_;
	}

	HIPRT_HOST_DEVICE void set_thin_walled(bool thin_walled)
	{
		flags.set_bool<PackedFlagsIndices::PACKED_THIN_WALLED>(thin_walled);
	}

	HIPRT_HOST_DEVICE void set_glass_energy_compensation(bool do_glass_energy_compensation)
	{
		flags.set_bool<PackedFlagsIndices::GLASS_ENERGY_COMPENSATION>(do_glass_energy_compensation);
	}

	HIPRT_HOST_DEVICE void set_thin_film(float thin_film)
	{
		sheen_roughness_transmission_dispersion_thin_film.set_float<PackedSheenRoughnessGroupIndices::PACKED_THIN_FILM>(thin_film);
	}

	HIPRT_HOST_DEVICE void set_thin_film_ior(float thin_film_ior_)
	{
	...
	{
		this->thin_film_thickness = thin_film_thickness_;
	}

	HIPRT_HOST_DEVICE void set_thin_film_kappa_3(float thin_film_kappa_3_)
	{
		this->thin_film_kappa_3 = thin_film_kappa_3_;
	}

	HIPRT_HOST_DEVICE void set_thin_film_hue_shift_degrees(float thin_film_hue_shift_degrees)
	{
		alpha_thin_film_hue_dielectric_priority.set_float<PackedAlphaOpacityGroupIndices::PACKED_THIN_FILM_HUE_SHIFT>(thin_film_hue_shift_degrees);
	}

	HIPRT_HOST_DEVICE void set_thin_film_base_ior_override(bool thin_film_base_ior_override_)
	{
		this->thin_film_base_ior_override = thin_film_base_ior_override_;
	}

	HIPRT_HOST_DEVICE void set_thin_film_do_ior_override(bool thin_film_do_ior_override)
	{
		flags.set_bool<PackedFlagsIndices::PACKED_THIN_FILM_DO_IOR_OVERRIDE>(thin_film_do_ior_override);
	}

	HIPRT_HOST_DEVICE void set_alpha_opacity(float alpha_opacity)
	{
		alpha_thin_film_hue_dielectric_priority.set_float<PackedAlphaOpacityGroupIndices::PACKED_ALPHA_OPACITY>(alpha_opacity);
	}

	HIPRT_HOST_DEVICE void set_dielectric_priority(unsigned char dielectric_priority)
	{
		alpha_thin_film_hue_dielectric_priority.set_uchar<PackedAlphaOpacityGroupIndices::PACKED_ALPHA_OPACITY>(dielectric_priority);
	}
	...
	{
		flags.set_bool<PackedFlagsIndices::PACKED_ENFORCE_STRONG_ENERGY_CONSERVATION>(enforce_strong_energy_conservation);
	}
...
private:
	...
	Float4xPacked specular_and_darkening_and_coat_roughness_and_retro_reflection;
...
struct DevicePackedTexturedMaterial : public DevicePackedEffectiveMaterial
{
	...
	HIPRT_HOST_DEVICE DeviceUnpackedTexturedMaterial unpack()
	{
		...
		if (out.metallic > 0.0f || !MaterialUtils::use_metallic_texture(out.metallic_texture_index, out.roughness_metallic_texture_index))
		{
			...
			out.retro_reflection		= this->get_retro_reflection();
	...
	HIPRT_HOST_DEVICE unsigned short int get_normal_map_texture_index() const
	{
		return normal_map_emission_index.get_value<NormalMapEmissionIndices::NORMAL_MAP_INDEX>();
	}
	HIPRT_HOST_DEVICE unsigned short int get_emission_texture_index() const
	{
		return normal_map_emission_index.get_value<NormalMapEmissionIndices::EMISSION_INDEX>();
	}
	HIPRT_HOST_DEVICE unsigned short int get_base_color_texture_index() const
	{
		return base_color_roughness_metallic_index.get_value<BaseColorRoughnessMetallicIndices::BASE_COLOR_INDEX>();
	}
	HIPRT_HOST_DEVICE unsigned short int get_roughness_metallic_texture_index() const
	{
		return base_color_roughness_metallic_index.get_value<BaseColorRoughnessMetallicIndices::ROUGHNESS_METALLIC_INDEX>();
	}
	HIPRT_HOST_DEVICE unsigned short int get_roughness_texture_index() const
	{
		return roughness_and_metallic_index.get_value<RoughnessAndMetallicIndices::ROUGHNESS_INDEX>();
	}
	HIPRT_HOST_DEVICE unsigned short int get_metallic_texture_index() const
	{
		return roughness_and_metallic_index.get_value<RoughnessAndMetallicIndices::METALLIC_INDEX>();
	}
	HIPRT_HOST_DEVICE unsigned short int get_anisotropic_texture_index() const
	{
		return roughness_and_metallic_index.get_value<AnisotropicSpecularIndices::ANISOTROPIC_INDEX>();
	}
	HIPRT_HOST_DEVICE unsigned short int get_specular_texture_index() const
	{
		return anisotropic_specular_index.get_value<AnisotropicSpecularIndices::SPECULAR_INDEX>();
	}
	HIPRT_HOST_DEVICE unsigned short int get_coat_texture_index() const
	{
		return coat_sheen_index.get_value<CoatSheenIndices::COAT_INDEX>();
	}
	HIPRT_HOST_DEVICE unsigned short int get_sheen_texture_index() const
	{
		return coat_sheen_index.get_value<CoatSheenIndices::SHEEN_INDEX>();
	}
	HIPRT_HOST_DEVICE unsigned short int get_specular_transmission_texture_index() const
	{
		return specular_transmission_index.get_value<SpecularTransmissionIndex::SPECULAR_TRANSMISSION_INDEX>();
	}

	HIPRT_HOST_DEVICE void set_normal_map_texture_index(unsigned short normal_map_index)
	{
		normal_map_emission_index.set_value<NormalMapEmissionIndices::NORMAL_MAP_INDEX>(normal_map_index);
	}
	HIPRT_HOST_DEVICE void set_emission_texture_index(unsigned short emission_index)
	{
		normal_map_emission_index.set_value<NormalMapEmissionIndices::EMISSION_INDEX>(emission_index);
	}
	HIPRT_HOST_DEVICE void set_base_color_texture_index(unsigned short base_color_index)
	{
		base_color_roughness_metallic_index.set_value<BaseColorRoughnessMetallicIndices::BASE_COLOR_INDEX>(base_color_index);
	}
	HIPRT_HOST_DEVICE void set_roughness_metallic_texture_index(unsigned short roughness_metallic_index)
	{
		base_color_roughness_metallic_index.set_value<BaseColorRoughnessMetallicIndices::ROUGHNESS_METALLIC_INDEX>(roughness_metallic_index);
	}
	HIPRT_HOST_DEVICE void set_roughness_texture_index(unsigned short roughness_index)
	{
		roughness_and_metallic_index.set_value<RoughnessAndMetallicIndices::ROUGHNESS_INDEX>(roughness_index);
	}
	HIPRT_HOST_DEVICE void set_metallic_texture_index(unsigned short metallic_index)
	{
		roughness_and_metallic_index.set_value<RoughnessAndMetallicIndices::METALLIC_INDEX>(metallic_index);
	}
	HIPRT_HOST_DEVICE void set_anisotropic_texture_index(unsigned short anisotropic_index)
	{
		roughness_and_metallic_index.set_value<AnisotropicSpecularIndices::ANISOTROPIC_INDEX>(anisotropic_index);
	}
	HIPRT_HOST_DEVICE void set_specular_texture_index(unsigned short specular_index)
	{
		anisotropic_specular_index.set_value<AnisotropicSpecularIndices::SPECULAR_INDEX>(specular_index);
	}
	HIPRT_HOST_DEVICE void set_coat_texture_index(unsigned short coat_index)
	{
		coat_sheen_index.set_value<CoatSheenIndices::COAT_INDEX>(coat_index);
	}
	HIPRT_HOST_DEVICE void set_sheen_texture_index(unsigned short sheen_index)
	{
		coat_sheen_index.set_value<CoatSheenIndices::SHEEN_INDEX>(sheen_index);
	}
	HIPRT_HOST_DEVICE void set_specular_transmission_texture_index(unsigned short _specular_transmission_index)
	{
		specular_transmission_index.set_value<SpecularTransmissionIndex::SPECULAR_TRANSMISSION_INDEX>(_specular_transmission_index);
	}
