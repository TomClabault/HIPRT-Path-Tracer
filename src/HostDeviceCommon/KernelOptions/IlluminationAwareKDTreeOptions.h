...
#define ILLUMINATION_AWARE_KD_TREE_NISML_NORMAL_DIVERSITY_HEURISTIC_NONE  0
#define ILLUMINATION_AWARE_KD_TREE_NISML_NORMAL_DIVERSITY_HEURISTIC_LOCAL 1
#define ILLUMINATION_AWARE_KD_TREE_NISML_NORMAL_DIVERSITY_HEURISTIC_FULL  2
...
/**
 * Returns whether the given direct-lighting options use learnt NEE distributions.
 *
 * The arguments may be runtime compiler-option values on the host or
 * compile-time kernel option macros on the device.
 */
...
#define IlluminationAwareKDTreeNISMLNormalDiversityHeuristic ILLUMINATION_AWARE_KD_TREE_NISML_NORMAL_DIVERSITY_HEURISTIC_LOCAL
