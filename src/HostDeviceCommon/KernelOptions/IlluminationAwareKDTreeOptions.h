...
#define ILLUMINATION_AWARE_KD_TREE_DEFAULT_SPP_LIMIT					 64
#define ILLUMINATION_AWARE_KD_TREE_DEFAULT_SPP_LIMIT_LEARNING_TO_CLUSTER 8
#define ILLUMINATION_AWARE_KD_TREE_DEFAULT_SPP_LIMIT_NISML				 32
 ...
 */
#define IlluminationAwareKDTreeMaximumLookaheadLevelCount 5
