...
#define FULL_SHADE_DURING_LAST_PASS_SKIP_SHADE_AROUND_CENTER 0
#define FULL_SHADE_OUTPUT_SKIP_SHADE_AROUND_CENTER 1
#define FULL_SHADE_OUTPUT_SKIP_SPATIAL_REUSE_SHADE_NEIGHBORS 2
#define FULL_SHADE_OUTPUT_SKIP_SPATIAL_REUSE_SHADE_OUTPUT 3
#define FULL_SHADE_AROUND_CENTER_SKIP_SHADE_AROUND_CENTER 4

#define ReSTIRDIFrameSkipDebugExperimentationMode FULL_SHADE_OUTPUT_SKIP_SHADE_AROUND_CENTER
