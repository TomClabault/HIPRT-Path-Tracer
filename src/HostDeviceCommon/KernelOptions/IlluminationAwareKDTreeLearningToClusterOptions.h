...
#define LEARNING_TO_CLUSTER_DEBUG_MODE_CELL_NORMAL_FACE_SOLID			2
#define LEARNING_TO_CLUSTER_DEBUG_MODE_CELL_NORMAL_FACE_OUTLINE			3
#define LEARNING_TO_CLUSTER_DEBUG_MODE_CELL_NORMAL_FACE_MESH_ID_SOLID	4
#define LEARNING_TO_CLUSTER_DEBUG_MODE_CELL_NORMAL_FACE_MESH_ID_OUTLINE 5
