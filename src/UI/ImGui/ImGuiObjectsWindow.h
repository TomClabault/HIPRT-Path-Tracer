...
public:
	...
	static bool draw_material_editor(CPUMaterial& material, const std::string& material_name, std::shared_ptr<GPUKernelCompilerOptions> kernel_options, bool& out_emission_changed);
