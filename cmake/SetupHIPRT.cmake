...
set(CONTRIB_OROCHI_PARALLEL_PRIMITIVES_PATH ${HIPRT_SUBMODULE_DIR}/contrib/Orochi/ParallelPrimitives)
set(CONTRIB_OROCHI_PARALLEL_PRIMITIVES_DESTINATION ${CMAKE_CURRENT_SOURCE_DIR}/contrib/Orochi)
message("Copying contrib/Orochi/ParallelPrimitives kernels from: ${CONTRIB_OROCHI_PARALLEL_PRIMITIVES_PATH} into ${CONTRIB_OROCHI_PARALLEL_PRIMITIVES_DESTINATION}")
# TODO remove when issue #7 (https://github.com/GPUOpen-LibrariesAndSDKs/HIPRT/issues/7) is fixed
file(COPY ${CONTRIB_OROCHI_PARALLEL_PRIMITIVES_PATH} DESTINATION ${CONTRIB_OROCHI_PARALLEL_PRIMITIVES_DESTINATION})
